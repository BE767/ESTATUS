    ...
    <body>
        ...
        <table class="table">
            ...
            <tbody>      
              ...
              <tr>             
                <td class="imagenIzquierda" style="padding: 0%;"><img  src="Imagenes/DS1W.png" ></td>
                <td class="contenedor">
                            ...
                            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1 start " >
                              <form  class="align-star">
                                <div class="d-flex flex-row align-items-center justify-content-center justify-content-lg-start">
                                  <p class="lead fw-normal mb-0 me-3">ULTIMA MODIFICACION </p>   
                                </div>
                                ...
                                <div class="row">
                                  ...
                                  <div class="row">
                                    <div class="col-md-6 mb-4">
                                      <div class="form-outline">
                                        <input type="text" id="form3Example1" class="form-control" placeholder="Ciudad/Estado"  />
                                        <label class="form-label" for="form3Example1">Ciudad/Estado</label>
                                      </div>
                                    </div>
                                    <div class="col-md-6 mb-4">
                                      <div class="form-outline">
                                        <input type="text" id="form3Example2" class="form-control" placeholder="Codigo Postal" />
                                        <label class="form-label" for="form3Example2">Codigo Postal</label>
                                      </div>
                                    </div>
                                  </div>
